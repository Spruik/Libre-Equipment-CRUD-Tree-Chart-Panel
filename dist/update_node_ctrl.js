...
System.register(['./utils'], function (_export, _context) {
  ...
  function prepareModalData(node, allData) {
    ...
    if (node.type === 'Site') {
      ...
      self = 'Area';
      filter = allData.filter(function (d) {
        return d.site === node.info.site && d.area !== null;
      });
      filter = filter.reduce(function (arr, record) {
      ...
      self = 'Line';
      filter = allData.filter(function (d) {
        return d.site === node.info.site && d.area === node.info.area && d.production_line !== null;
      });
      filter = filter.reduce(function (arr, record) {
      ...
      self = 'Equipment';
      filter = allData.filter(function (d) {
        return d.site === node.info.site && d.area === node.info.area && d.production_line === node.info.line && d.equipment !== null;
      });
      filter = filter.reduce(function (arr, record) {
